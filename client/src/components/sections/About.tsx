...
export default function About() {
  ...
  return (
    <section id="about" className="py-20 px-6 bg-slate-100 dark:bg-slate-900" ref={ref}>
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          >
            <p className="text-lg mb-6 leading-relaxed text-gray-800 dark:text-gray-200">
            ...
            <div className="mb-6">
              <h3 className="text-xl font-semibold mb-4 text-primary dark:text-gray-100">Education</h3>
              {resumeData.education.map((edu, index) => (
                <div key={index} className="mb-5 pl-4 border-l-2 border-accent">
                  <div className="flex justify-between items-start">
                    <div>
                      <h4 className="font-semibold text-primary dark:text-gray-100">{edu.degree}</h4>
                      <p className="text-gray-600 dark:text-gray-400 text-sm">{edu.institution}</p>
                    </div>
                    <span className="text-secondary font-medium text-sm">{edu.endDate}</span>
                  </div>
          ...
          >
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-gray-200 dark:border-slate-600 shadow-sm">
              <h3 className="text-xl font-semibold mb-5 text-primary dark:text-gray-100">Quick Stats</h3>
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="text-center bg-slate-50 dark:bg-slate-700 rounded-lg p-3">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-gray-200 dark:border-slate-600 shadow-sm">
              <h3 className="text-xl font-semibold mb-5 text-primary dark:text-gray-100">Connect</h3>
              <div className="flex flex-col gap-3">
                <a href={resumeData.linkedInUrl} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-3 text-gray-700 dark:text-gray-300 hover:text-secondary transition-colors duration-200">
