          ...
          >
            ...
            >
              ...
              <button
                ...
                className="px-6 py-3 bg-white hover:bg-gray-50 text-blue-600 border-2 border-blue-600 rounded-md transition duration-300 font-medium disabled:opacity-70"
              >
